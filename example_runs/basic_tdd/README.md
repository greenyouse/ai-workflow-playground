...
The output is basically garbage right now because the plan it gets is bad. I'll reused the repo context collector to improve the implementation plan and then update the example here. It should help a lot.
